...
export const BrowseVideo = {
	src: `${config.BASE_PATH}/video/formula1`,
	logo: `${config.BASE_PATH}/video/formula1/logo`,
	backdrop: `${config.BASE_PATH}/video/formula1/backdrop`,
...
export const SeriesVideo = {
	src: `${config.BASE_PATH}/video/dirty`,
	logo: `${config.BASE_PATH}/video/dirty/logo`,
	backdrop: `${config.BASE_PATH}/video/dirty/backdrop`,
	title: "Dirty Money",
	description:
...
export const FilmsVideo = {
	src: `${config.BASE_PATH}/video/night`,
	logo: `${config.BASE_PATH}/video/night/logo`,
	backdrop: `${config.BASE_PATH}/video/night/backdrop`,
